...
v1.2.3 — Indicador de conexão corrigido: o texto não informa mais 'Offline' quando há internet; o SGC verifica o estado da rede e atualiza Online/Offline automaticamente.

v1.3 — PWA OFFLINE-FIRST
- O SGC agora pode ser instalado como aplicativo no iPad e celular por meio do navegador.
- Mantém o link web para notebook.
- Service Worker adiciona cache do sistema para abertura e uso sem internet depois do primeiro carregamento online.
- Os dados continuam locais no dispositivo; não foi criada uma sincronização em nuvem fictícia.
- Próxima etapa de infraestrutura: backend/banco online + fila de sincronização, preservando o funcionamento offline.
