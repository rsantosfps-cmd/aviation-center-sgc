...
function newSession(){
  ...
  fillSession(s,false);
  // Mantém a ficha de nova calibração limpa: nenhum dado da calibração anterior permanece na tela.
...
document.querySelectorAll(".nav").forEach(b=>b.addEventListener("click",()=>{
  ...
  if(view==="session"){
    // Nova calibração sempre começa vazia e nunca reaproveita a ficha anterior.
    newSession();
    return;
  }
  showView(view);
